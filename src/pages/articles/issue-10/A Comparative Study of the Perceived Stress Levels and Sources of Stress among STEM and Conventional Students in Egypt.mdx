...
import Tb from '../../../components/markdown/Tb.astro';
...
export const components = { table: Table, thead: Thead, tbody: Tb, tr: Tr, th: Th, td: Td, p: Para, h1: HeadingOne, h2: HeadingTwo, h3: HeadingThree, h4: HeadingFour, h5: HeadingFive, h6: HeadingSix };
